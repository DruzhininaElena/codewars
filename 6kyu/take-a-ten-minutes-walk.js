...
function isValidWalk(walk) {
    function getLengthDirection(direction) {
        return walk.filter(el => el === direction).length
    }
    return walk.length === 10 &&
        getLengthDirection('w') === getLengthDirection('e') &&
        getLengthDirection('n') === getLengthDirection('s')
